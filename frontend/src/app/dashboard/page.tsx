...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-r from-purple-600/20 to-indigo-600/20 backdrop-blur-xl border-b border-purple-500/30">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 lg:px-8 py-4">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg">
              <svg className="w-6 h-6 lg:w-7 lg:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>            
            <div>
              <h1 className="text-lg lg:text-xl font-bold text-white">Rider's Club Bangladesh</h1>
              <p className="text-xs lg:text-sm text-purple-300">Dashboard</p>
            </div>
          </div>
          ...
          <button
            ...
            className="p-2 lg:p-3 rounded-xl bg-red-500/20 text-red-300 hover:bg-red-500/30 transition-all shadow-lg"
            title="Logout"
          >
      ...
      </div>      {/* Main Content - Desktop Layout */}
      <div className="flex-1 flex">
        {/* Desktop Sidebar */}
        <div className="hidden lg:block w-80 xl:w-96 p-6 lg:p-8 bg-gradient-to-b from-white/5 to-white/10 backdrop-blur-xl border-r border-white/20">
          {/* Profile Card - Sidebar Version */}
          <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-3xl p-4 mb-6 border border-white/30 shadow-2xl">
            {/* Profile Header */}
              ...
              <div className="mt-3">
                <div className="flex items-center justify-center mb-1">
                  ...
                  <button
                    ...
                    className="ml-2 p-1 bg-white/10 hover:bg-white/20 rounded-lg transition-colors"
          ...
          <div className="space-y-4">
            ...
            <button 
              ...
              className="w-full group bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-xl rounded-2xl p-4 border border-blue-400/30 hover:border-blue-400/60 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-blue-300 text-xs">Get assistance</p>
                </div>
              </div>
            </button>
            ...
            <button 
              ...
              className="w-full group bg-gradient-to-br from-emerald-500/10 to-green-500/10 backdrop-blur-xl rounded-2xl p-4 border border-emerald-400/30 hover:border-emerald-400/60 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-emerald-300 text-xs">Security settings</p>
                </div>
              </div>
            </button>
          </div>
          ...
          {/* Main Content Area */}
        <div className="flex-1 p-2 sm:p-4 lg:p-8 xl:p-12 pb-20 max-w-7xl mx-auto">
          {/* Mobile Profile Card - Only show on mobile */}
          <div className="lg:hidden bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-3xl p-3 mb-6 border border-white/30 shadow-2xl">
            {/* Profile Header */}
          ...
          {!noticesLoading && notices.length > 0 && (
            <div className="mb-6 lg:mb-8 overflow-hidden relative w-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl rounded-2xl p-3 lg:p-4 border border-blue-400/20">
              <div 
                className="whitespace-nowrap text-white text-base lg:text-lg font-medium"
                style={{
        ...
        <div className="mb-6">
          <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-3xl p-3 lg:p-6 border border-white/30 shadow-2xl">
            {/* Tab Headers */}
            <div className="flex bg-white/10 backdrop-blur-sm rounded-2xl p-1 mb-6 lg:mb-8">
              <button 
                onClick={() => setActiveEventTab('upcoming')}
                className={`flex-1 py-3 px-4 lg:py-4 lg:px-6 rounded-xl font-semibold transition-all duration-300 ${
              ...
              >
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="text-sm lg:text-base">Upcoming Events</span>
                </div>
              </button>
              <button 
              ...
              >
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="text-sm lg:text-base">Previous Events</span>
                </div>
              </button>
            </div>
            ...
            <div className="min-h-[200px] lg:min-h-[300px]">
              {activeEventTab === 'upcoming' && (
                <div className="space-y-4">                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl lg:text-2xl font-bold text-white">Upcoming Events</h3>
                ...
                <div className="space-y-4">                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl lg:text-2xl font-bold text-white">Previous Events</h3>
                    <div className="flex items-center space-x-1">
                      <div className="w-2 h-2 bg-gray-400 rounded-full"></div>
                      <span className="text-gray-400 text-xs lg:text-sm font-medium">{pastEvents.length} Events Completed</span>
                    </div>
                  </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3 px-2">
            <h3 className="text-xl lg:text-2xl font-bold text-white">All Benefits For Rider's Club Members</h3>
            <div className="flex items-center space-x-1">
          ...
          {benefitsLoading ? (
            ...
            <div className="space-y-4 lg:grid lg:grid-cols-2 xl:grid-cols-3 lg:gap-6 xl:gap-8 lg:space-y-0">
              ...
              <div className="text-center pt-6 lg:pt-8 lg:col-span-2 xl:col-span-3">
                <Link 
                  href="/benefits" 
                  className="inline-flex items-center bg-gradient-to-r from-purple-600/20 to-blue-600/20 hover:from-purple-600/40 hover:to-blue-600/40 border border-purple-500/30 text-purple-300 hover:text-white font-medium py-3 px-6 lg:px-8 rounded-xl transition-all duration-300 text-sm lg:text-base"
                >
        ...
        )}          {/* Enhanced Quick Actions - Hidden on desktop, visible on mobile */}
        <div className="lg:hidden grid grid-cols-2 gap-4 mb-6">
          ...
          >
            <div className="text-center">
              ...
              </div>              <p className="text-white text-sm font-bold">Change Password</p>

...
interface FormData {
  ...
  // Password fields for user account creation
  password: string;
...
export default function JoinPage() {
  ...
  const calculateProgress = (): number => {
    const requiredFields = [
      ...
      'address', 'zone', 'emergencyContact', 'emergencyPhone', 'password', 'confirmPassword'
    ];
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  />
                  <p className="text-gray-400 text-sm mt-1">Password must be at least 8 characters long</p>
